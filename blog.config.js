...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Horace', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'chatgpt学习者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-xi-black.vercel.app', // 网站地址
